...
if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then 
		...
		coroutine.resume(
			coroutine.create(
				function()
					...
					Circle.ZIndex = 10
					Circle.Image = "rbxassetid://18807365797"
	...
	function library:Evil()
		...
		Logo.Image = "rbxassetid://18807365797"
		...
		Logo_Background.Image = "rbxassetid://18807365797"
	...
	function LoadSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfolder("Long Nhat") then
				makefolder("Long Nhat")
			end
			if not isfolder("Long Nhat/Blox Fruits/") then
				makefolder("Long Nhat/Blox Fruits/")
			end
			if not isfile("Long Nhat/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				writefile("Long Nhat/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
			else
				local Decode = game:GetService("HttpService"):JSONDecode(readfile("Long Nhat/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
	...
	function SaveSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfile("Long Nhat/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				...
				writefile("Long Nhat/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
			end
		else
			return warn("Status : Undetected Executor")
		end
...
function GetMaterial(matname)
	...
	CredtSection:AddLabel({
		Name = "AnBaToCom Hub By Long Nhat Hub#6264\nUi library Made By Ares\nCrack By Long Nhat"
	})
...
FakeDamage("gia minh")
Vec("<Color=Yellow>Long Nhat loaded Finished<Color=/>")
